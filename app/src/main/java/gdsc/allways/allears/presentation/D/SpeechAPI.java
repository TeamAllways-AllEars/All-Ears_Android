...
public class SpeechAPI {
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected AccessToken doInBackground(Void... voids) {
            ...
            // todo ***** WARNING *****
            //  I load the credential from a JSON file stored in a raw resource
            //  folder of this client app.
            //  Indeed, I should never do this in my app. Instead, store
            //  the file in my server and obtain an access token from there.
            //  *******************
            final InputStream stream = mContext.getResources().openRawResource(R.raw.credential2);  // credential json file
            try {
